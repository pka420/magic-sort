...
interface RestartProps {
   ...
   * another bench away is never a surprise.
   */
...
/**
 * Restarting throws away a bench in progress and costs the campaign points,
 * so the line under the button names that price before anyone pays it.
 *
 * An apprentice who cannot pay the price is pressing the end of their run,
 * which the line says outright: nothing here is bought on credit, so a bench
